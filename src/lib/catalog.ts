...
export const catalog: CatalogItem[] = [
  ...
  },
  {
    ...
    lede: "A flat span and a round back, formed from stock coil so a strap or a hook stays put.",
    body: [
      "A D-ring is a closed form: bend, close, weld at the joint when the print wants a continuous loop. Name inside width, diameter, and whether the joint is welded or butted.",
      "Usual coil is 1018, zinc after form. 304 when the strap lives outside.",
    ],
    jobs: [
      "Tie-down and strap D-rings",
  ...
  },
  {
    ...
    group: "Hangers",
    summary:
      "Open-loop and side-mount cable supports in 3/8, 7/16, and 1/2 in for mines, plants, and utility.",
    lede: "Round-wire hangers that hold cable off the floor or off structure. Stock diameters — not a patented locking catalog.",
    body: [
      "Hangers here are 2D or 3D CNC from 3/8, 7/16, or 1/2 in. Open loops, J-hangs, side-mounts to the customer’s print. Zinc, powder, or 316. We form round wire; a rolled-flat ring with a stamped saddle is a different process.",
      "We do not quote captive locking-arm hangers, cooperating gripper-hook catalogs, or a reverse of those SKUs. Trays are a separate item when the run is a welded channel.",
    ],
    jobs: [
      "Open-loop cable supports",
      "Side-mount hangers",
      "Mining roof and rib hangers",
  ...
  },
  {
    ...
    group: "Hangers",
    summary:
      "Round-wire solar row hardware — J-hooks and structure mounts in 3/8, 7/16, and 1/2 in, 304 or galv. Not a patented clip catalog.",
    lede: "Structure-mounted hooks and U-hangers under a tracker or a fixed-tilt row. Outdoor coil, customer print.",
    body: [
      "Solar hangers in this shop are round 3/8, 7/16, or 1/2 in J-hooks and U-hangers that hang or bolt from a purlin, pier, or rack. 1018 galvanized or 304 / 316. Pre-galv that cracks at the bend is the wrong finish for a 25-year array.",
      "We do not quote locking messenger hangers, cooperating gripper-hook catalogs, snap-on torque-tube hangers, or a round-wire lookalike of those SKUs. Send the customer’s drawing.",
    ],
    jobs: [
      "J-hooks off purlin or pier",
      "U-hangers that bolt to rack steel",
      "Pad and row structure mounts",
  ...
  },
  {
    ...
    lede: "A rim plus a mesh, welded so it carries load. Stock coil — not a chrome display basket.",
    body: [
      "Resistance on the intersections, MIG or TIG on corners and mounts. Infill and rim are often different diameters. Name both. 1018 zinc for plant and harvest; 304 for washdown; 330 for heat-treat.",
      "This is a welded product, not a bent clip.",
    ],
    jobs: [
      "Material-handling and parts wire baskets",
      "Harvest and agriculture wire baskets",
      "Facility and data-center cable wire baskets",
      "Heat-treat and furnace wire baskets in 330",
    ],
    quote: "Have a wire basket print?",
    processHref: "/processes/mesh-grids-and-cable-trays",
    related: ["mesh-grids", "wire-shelves", "load-loops"],
  },
  {
    slug: "cable-trays",
    title: "Cable trays",
    ...
    lede: "Welded wire channel: mesh bottom, sidewalls, lip, splices. Stock diameters on the rim and the runners.",
    body: [
      "Usual coil is 1018, zinc after weld, in 3/8 or 7/16 in. 1/2 in when the span is structural. 304 when the spec is stainless. Resistance on intersections; MIG on lips and splices.",
      "Hangers are a separate SKU when the run is a strand instead of a tray.",
    ],
    jobs: [
      "AI and data-center trays",
      "Solar row cable trays",
      "Mining and plant-floor trays",
  ...
  },
  {
    ...
    lede: "A fence that is a welded panel: rim, mesh, mounts. Stock coil on the border. Pitch named. Galvanized or 304.",
    body: [
      "Security mesh fencing here is the same cell as partitions and machine guards: resistance weld on the intersections, MIG on corners, posts, and gate frames. 3/8 in for medium panels; 7/16 and 1/2 in when the span or the hit is real. Infill can be lighter than the rim — name both.",
      "This is not chain-link from a roll, and not a 9-gauge garden fence. Posts, hinges, and latches are formed or welded when they are wire. Bought hardware is named on the quote.",
    ],
    jobs: [
      "Facility and plant security panels",
      "Yard and compound fence in welded mesh",
  ...
  },
  {
    ...
    processHref: "/processes/mesh-grids-and-cable-trays",
    related: ["heavy-duty-wire-baskets", "wire-racks", "mesh-grids"],
  },
  {
    slug: "machine-guards",
  ...
  },
  {
    ...
    lede: "A structure plants climb. Heavy frames and welded panels in stock coil — commercial vertical growing, not garden-center mesh.",
    body: [
      "Imported climber mesh is often 2.5–4.5 mm. That sits at or under our 4 mm floor. What we run is the structure: 3/8, 7/16, and 1/2 in frames, posts, rims, and wall mounts, with welded mesh infill when the pitch is on the print. 1018 galvanized or 304. In-line powder when the color is specified.",
    ...
    jobs: [
      "Commercial vertical-garden frames and wall armatures",
      "Espalier and vine / hop row structures",
  ...
  },
  {
    ...
    lede: "A frame plus decks plus hooks. Stock coil, CNC, then weld.",
    body: [
      "Racks combine frames, shelves, and often S-hooks or display hooks. 3/8 in for light plant racks; 7/16 and 1/2 in for parts racks. Resistance and MIG. Zinc or powder.",
      "Send the assembly, not three unrelated prints.",
    ],
    jobs: [
      "Parts and tool racks",
      "Harvest and plant racks",
      "Display racks in heavy wire",
  ...
  },
  {
    ...
    related: ["handles", "heavy-duty-wire-baskets", "wire-racks"],
  },
  {
    slug: "ground-staples",
    ...
    lede: "A U that holds fabric, cable, or soil. Heavy production on the three stock diameters.",
    body: [
      "A staple is 2D CNC plus cutoff. Volume is high, geometry is simple, finish is usually galvanized 1018. 3/8 in and neighbors for erosion, agriculture, and cable that a light sod staple will not hold.",
      "If the print is 9-gauge landscape wire under 4 mm, we will say so.",
    ],
    jobs: [
      "Erosion and landscape fabric staples",
      "Irrigation and cable hold-downs",
      "Agriculture field staples",
      "Solar field staples",
    ],
