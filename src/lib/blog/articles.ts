...
export const articles: BlogPost[] = [
  {
    ...
    blocks: [
      ...
      {
        type: "p",
        text: "Fourslide and transfer tools can take a day to set. That shop needs volume to justify the downtime. A CNC cell that programs from the print can run a hundred pieces. Mix those two in one RFQ blast and one quote looks “expensive” only because the machine was never right. The engine asks for the cell class first — spring, 2D CNC, 3D CNC, straighten & cut to length, fourslide, multi-slide — then the wire size. Six shops that filed that kind of cell and a band that fits see a teaser. First two to unlock get contact. Hungry shops that filed fullness this week sit higher in that six.",
      },
      {
        type: "h2",
        id: "how",
