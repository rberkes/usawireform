export const industries = [
  ...
  },
  {
    ...
    title: "Solar",
    summary:
      "Messenger and structure solar hangers, multi-carrier supports, welded row trays, and outdoor 1018 galv or 304 — coat after form, to the array print.",
  },
  {
    slug: "mining",
    title: "Mining",
  ...
  },
  {
    ...
    summary:
      "Contract forms to the OEM print: frames, handles, guards, and hardware in 3/8, 7/16, and 1/2 in.",
  },
  {
    slug: "electrical",
    title: "Electrical",
...
export const shopLines = [
  {
    ...
    summary:
      "Chairs, tables, racks, and frames formed and welded in 3/8, 7/16, and 1/2 in wire — indoor and outdoor.",
  },
  {
