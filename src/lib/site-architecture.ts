  ...
  return [
      ...
      children: [
        ...
        })),
        {
          ...
          children: [
            ...
            leaf("/powder-coating-hooks/super-v-hooks", "Super V, round wire"),
            leaf("/powder-coating-hooks/locking-v-hooks", "Locking V, round wire"),
            leaf("/powder-coating-hooks/z-hooks", "Z-path, not Z-bar"),
            ...
            leaf("/powder-coating-hooks/hcv-series-cv-hooks", "HCV CV, in-band only"),
            leaf("/powder-coating-hooks/hv90-series-90-degree-v-hooks", "HV90 90° V, in-band"),
    ...
    },
    {
      ...
      children: [
        ...
        leaf("/admin/preview", "Buyer and shop dashboard previews", "desk"),
        leaf("/admin/preview/buyer", "Generic buyer dashboard", "desk"),
        leaf("/admin/preview/shop", "Generic shop dashboard", "desk"),
