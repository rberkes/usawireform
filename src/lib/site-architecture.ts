    ...
    },
    {
      ...
      children: [
        ...
        })),
        {
          ...
          kind: "branch" as const,
          children: [
            leaf("/powder-coating-hooks", "Hook family"),
            ...V_HOOK_LANDERS.map((lander) => leaf(lander.path, lander.title)),
            leaf("/v-hooks", "V-hooks"),
            leaf("/c-hooks", "C-hooks"),
            leaf("/cv-hooks", "CV-hooks"),
            leaf("/s-hooks", "S-hooks"),
            leaf("/90-degree-hooks", "90° family"),
      ...
      children: [
        ...
        leaf("/directory/areas/[slug]", `${s.metros} metro landers`, "pattern"),
        {
          ...
          children: [
            ...
            leaf("/source/shops", "Claim listing or file a cell"),
            leaf("/source/equipment", "Register plant · file cells"),
            leaf("/source/upgrade", "1 / 4 / 10 / 20 cells"),
            leaf("/source/claim", "Claim /directory/[slug]", "desk"),
            leaf("/source/dashboard", "Shop desk", "desk"),
