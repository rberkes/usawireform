...
- Source (/source) is the trade for USA shops: they file CNC cells, buyers match jobs to that iron. Instant estimate stays this floor. Shop dashboard /source/dashboard. Account /source/account (email, password). Plans /source/upgrade: one cell free; $30/mo for 4; $49/mo for 10; $99/mo for 20. Secondaries $5/mo each from the dashboard (end forming, weld, plate, heat treat, inspection). Newest members: /directory/new. Confirm account from the equipment receipt. A Source shop public page is /directory/[slug] from the dashboard shop form. Existing US directory shops claim that same URL from the listing (Claim this page) then file cells. Canada stays in the directory only. Europe later, on its own platform.
