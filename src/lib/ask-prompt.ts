...
- /find-factories-by-machine is typeahead against a machine index (OEM, model, class), not shop blurbs. An engineer types a machine and up to four plants that have a hit drop in. Class terms filter the directory. OEM names only hit shops that named that OEM — Robomac does not dump every 3D CNC plant. Empty means nobody on the list named it. Query hits a server index so a shop with twenty cells does not ship to the browser. Instant estimate stays this floor.
...
- Blog article for 22 Aug 2026: /blog/fall-shows-for-wire-forming-shops — IMTS Chicago Sept 14–19, FABTECH Las Vegas Oct 21–23, Assembly Show Rosemont Oct 27–29, Interwire Atlanta May 4–6 2027. We do not exhibit. We do not sell machines. Wire Expo Milwaukee already ran in May.
