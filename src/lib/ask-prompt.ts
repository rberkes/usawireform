...
- /directory lists other shops (USA and Canada). /wire-form-factories-in-usa is USA-only company cards. Sales and sourcing offices are out. Claim requires three checks: plant street, floor proof URL, attestation it is not a desk. Filter ?iron=fourslide, 3d-cnc, 2d-cnc, straighten-cut, multi-slide, spring-cnc. Equipment tags are from public pages, not a floor walk. We run a 214TF.
...
- /admin/architecture is the one-page site tree (password). Do not send visitors there. /site-map is the flat public list.
- Source for buyers is /source: pick the cell first (spring, 2D CNC, 3D CNC, straighten & cut to length, fourslide, multi-slide) then wire size, ZIP. Six shops that filed that kind of cell and a band that fits see a teaser. Matching is capability first (cell class + diameter), then same-state shops from the ZIP fill the six, then fullness. First two to unlock get contact — first come. Buyer accounts /sign-up?as=buyer or log in /sign-in?as=buyer then /buyer/dashboard — jobs, drawing privacy, monthly volume. Two shops can buy first — first come. If the buyer wants another quote, $49 opens the next shop in line. They can close the print so the waitlist stops. Shop names and cities stay with the desk. Shops see cell, wire, qty, and a masked buyer email until they buy the lead — not buyer locale or full email. Prints are STEP, DXF, SLDPRT, or PDF. Excel and other files only after the buyer confirms the account and the desk validates them on /admin/accounts. A STEP is never attached to email. Do not tell buyers about shop fees. If a visitor is a shop, send them to /source/shops: list every cell free; ${SOURCE_SMART_CONNECT_LINE} in the dashboard; six shops see the teaser; same-state shops that can run it sit there first; first two to unlock get contact; others wait if the buyer wants another quote. Supplier sign-up /sign-up?as=supplier then /source/dashboard. Shops open a released file in the dashboard only after they buy the lead. Master admin /admin/accounts lists both. Shops file a company slider 0–100% full (0% needs work, 100% = no capacity). Hungry shops that filed this week rank higher among shops that already fit. Stale weeks (>8 days) get no capacity boost — we do not invent idle machines. We email listed shops on the 1st and 15th Eastern to move that slider. /source/job redirects to /source. How the plant operates (min order, setup, stocked materials, lead) is free on the listing. Weekly plant fullness is free on the dashboard. Instant estimate stays this floor. Shop dashboard /source/dashboard. Account /source/account (email, password). Pricing /source/upgrade: list free; ${SOURCE_SMART_CONNECT_LINE}. Secondaries: 3 top ops $19/mo, six maximum $49/mo from the dashboard (zinc, powder, TIG, MIG, resistance/laser/robotic weld, press brake, end forming, heat treat, and the rest of the named list). Newest members: /directory/new. Confirm account from the equipment receipt or the on-page button. A Source shop public page is /directory/[slug]. Existing US directory shops claim that same URL then file cells. Canada stays in the directory only.
- Quote email: ${QUOTE_EMAIL}. Quote pages: /contact, /instant-quote, and /custom-cnc-wire-forming-services.
- Powder coating hooks hub: /powder-coating-hooks (keyword cloud + market). Branches under that root: /powder-coating-hooks/v-hooks, /c-hooks, /cv-hooks, /cv-hooks/3d (Autodesk Viewer of the CV path we form), /s-hooks, /90-degree-hooks, /square-hanging-hooks, /prices, /listed-bags, /hc-series-c-hooks, /hs-series-s-hooks, /hv-series-v-hooks, /hcv-series-cv-hooks, /hv90-series-90-degree-v-hooks, /super-v-hooks, /locking-v-hooks, /z-hooks, /jam-hooks, /snap-hooks, /j-hooks, /stainless, /steel, /heavy-duty, /custom, /paint-hooks, /e-coat-hooks, /rack-hooks, /conveyor-hooks, /finishing-hooks, /hangers, /grounding-hooks, /wash-line-hooks, /curing-oven-hooks, /4-10mm, /375, /specialty-hooks, /market, plus style subpages (stainless, 90-degree, paint-line, e-coat). Old /v-hooks, /c-hooks, /s-hooks, /cv-hooks, /90-degree-hooks, /square-hanging-hooks, /powder-coating-hook-prices 301 here. Listed 0.180 / 0.250 in bags: /powder-coating-hooks/listed-bags — 5% under published HV/HC/HS/HCV/HV90 0.180 in and 0.250 in boxes, same length, bowl or legs, and box count; USAWF part numbers, not catalog SKU strings. We do not list 0.060–0.120 in, HKD diamond (square wire), C-LAW, HKRO spring-tube, HKVL locking-V bags (all under 4 mm), swivels, or wheel kits. Bag prices 4–10 mm V/S/C: /powder-coating-hooks/prices — 2% under published 0.180 in and 0.250 in bag cards, same lengths and bag counts; metric 4, 5, 6, 8, 10 mm on the same length grid. Carbon, steel in the lot. 100-piece minimum. Square hanging (squared V): /powder-coating-hooks/square-hanging-hooks — 5% under published HSQV 1-bag and 10-bag cards at 0.180, 0.250, and 0.375 in, same lengths; SH375-24 is 100 pcs (their 50-pc bag doubled, then 5% off). We do not form 0.044–0.120 in catalog hooks. Named houses on /powder-coating-hooks/market: Mighty Hook, Magic Rack / Production Plus, Hook Authority, Argon USA (HSQV), EPSI, Echo Supply, HangOn, Essentra — we do not sell their racks or masking. V-hooks for finishing: /powder-coating-v-hooks (builder). Sizes: /375-v-hooks stock 3/8 in. Heavy-duty 3-column calculator: /heavy-duty-v-hooks — 3/8 in is (cuts × $1) + (developed inches × $0.09) plus shop steel, then 5% under boxed 0.375 in; 7/16 in and 1/2 in are stock on this cell (not a boxed 0.375 catalog size) — inch rate × (d ÷ 3/8)² plus steel, then the same 5% off. Bends are on the drawing, not billed. Custom builder: /custom-powder-coating-hooks and /custom-v-hooks. Stainless: /stainless-steel-powder-coating-hooks and /stainless-steel-v-hooks. Guide: /guide/s-hooks-vs-v-hooks-vs-c-hooks. We form 4–14 mm. 4 mm (0.157 in) is the step up from 0.120 in. V and 90° V formula: [(cuts × $1) + (developed inches × $0.09 at 3/8 in, scaled by (d/0.375)²) plus steel mass × alloy $/lb (1018 $0.90, galv $0.95, 304 $3.20, 316 $4.40)] × 0.95. C, CV, S, and other CNC: (cuts × $1) + (bends × $0.50) + (developed inches × $0.05), material not included, except listed 4–10 mm S and C bags on /powder-coating-hooks/prices and listed 0.180 / 0.250 in boxes on /powder-coating-hooks/listed-bags which include carbon. Quantity −5% at 1,000, −10% at 10,000.
