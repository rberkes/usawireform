...
export const staticSeoPages: SeoRecord[] = [
  ...
  record({
    ...
    description: `CNC wire forming from first print to production. Instant quote or send a STEP. ${PRICE_LINE}`,
    section: "company",
    keywords: [
  ...
  record({
    ...
    description: `Send a STEP for a production wire forming quote. ${COMPANY} reviews the print and prices the lot. ${PRICE_LINE}`,
    section: "company",
    keywords: ["production wire forming quote", "send STEP wire form"],
    priority: 0.8,
    changeFrequency: "weekly",
  }),
  record({
    ...
    description: `${COMPANY} CNC wire forming for purchasing: 4–14 mm from coil, 100-piece minimum. Instant or production quote.`,
    section: "company",
    keywords: ["CNC wire forming quote", "buy CNC wire forms"],
    priority: 0.7,
    changeFrequency: "weekly",
  }),
  record({
  ...
  record({
    ...
    section: "legal",
    keywords: ["privacy policy", "USA Wire Form privacy"],
    priority: 0.3,
  }),
  record({
    path: "/terms",
    title: "User Agreement",
    description: `${COMPANY} user agreement: copyright, trademarks, and rules against copying the site, code, or structure.`,
    section: "legal",
    keywords: [
      "user agreement",
      "terms of use",
