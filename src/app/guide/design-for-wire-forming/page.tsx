...
export const metadata = pageMeta({
  ...
  keywords: [
    ...
    "wire form tolerances",
    "CNC wire design guidelines",
  ],
});

const faqs = [
  {
    question: "What bend radius should I use for wire forming?",
    answer: "For mild carbon steel in the 4-14mm range, use an inside radius of at least 1× the wire diameter. For stainless and high-tensile materials, use 1.5-2× diameter. Soft copper and aluminum can go tighter but watch for marking.",
  },
  {
    question: "What tolerances are typical for wire forms?",
    answer: "Non-critical linear dimensions: ±0.015 inch. Critical linear dimensions: ±0.005 inch with a fixture. Non-critical angles: ±2°. Critical angles: ±0.5° to ±1°.",
  },
  {
    question: "What file formats work best for wire forming quotes?",
    answer: "STEP or DXF files plus a PDF with critical dimensions work best. A wire centerline (curve) plus diameter is better than a solid sweep with no path. Ensure bend radii are modeled, not sharp polylines.",
  },
  {
    question: "How do I specify wire form ends?",
    answer: "Square cut is the default. Specify chamfer for insertion, flatten/coin for weld or rivet, thread for fasteners. For loops, call out the inside diameter and gap (or specify if a weld is needed).",
  },
  {
    question: "What is springback in wire forming?",
    answer: "Springback is when wire returns some of its bend angle after forming. Higher yield strength, larger radius, and certain stainless grades return more. Compensation is handled in the CNC program, but the print must name the alloy for accurate compensation.",
  },
];

const howToSteps = [
  {
    name: "Specify wire diameter and material",
    text: "Include wire diameter and complete material spec including alloy, tensile or temper, and coating requirements.",
  },
  {
    name: "Define bend radii",
    text: "Specify inside bend radii - not 'sharp' corners. Use minimum 1× diameter for carbon steel, 1.5-2× for stainless.",
  },
  {
    name: "Add critical dimensions only",
    text: "Call out critical-to-fit dimensions with datums from the mating part. Let non-mating bends float at process capability.",
  },
  {
    name: "Specify end conditions",
    text: "Define end treatment: square cut, chamfer, coin, flatten, thread, or loop with inside diameter.",
  },
  {
    name: "Call out finish requirements",
    text: "Specify finish: none, zinc, nickel, powder, or passivate. Note whether pre-coated wire is acceptable.",
  },
  {
    name: "Provide proper CAD files",
    text: "Submit STEP or DXF files plus PDF with critical dims. Include wire centerline with diameter, modeled bend radii.",
  },
];
...
export default function DesignGuidePage() {
  ...
  return (
    <>
      ...
      <HowToSchema
        name="How to Design Wire Forms for Manufacturing"
        description="Step-by-step guide to creating wire form designs that are optimized for CNC manufacturing, including bend radius, tolerances, and file format requirements."
        steps={howToSteps}
      />
      <ArticleSchema
        headline="Design for Wire Forming - DFM Guidelines"
        description="Complete design-for-manufacturing guide for 2D and 3D CNC wire forms covering bend radius, tolerances, springback, and CAD file requirements."
        url="/guide/design-for-wire-forming"
      />
      <BreadcrumbJsonLd
        items={[
          { name: "Guide", url: "/guide" },
          { name: "Design for Wire Forming", url: "/guide/design-for-wire-forming" },
        ]}
      />
      <DocPage
        kicker="Guide"
