...
const searchItems: SearchItem[] = [
  ...
  { title: "EPSI-Match Hook Prices", href: "/powder-coating-hooks/epsi", category: "Products", description: "0.180 and 0.250 in V, C, S, CV, 90° V. 5% under published EPSI boxes. Not light wire, diamond, or C-LAW." },
  { title: "HC Series C-Hooks", href: "/powder-coating-hooks/hc-series-c-hooks", category: "Products", description: "Round-wire C-hooks matching EPSI HC 0.180 and 0.250 in boxes. 5% under." },
  { title: "HS Series S-Hooks", href: "/powder-coating-hooks/hs-series-s-hooks", category: "Products", description: "Round-wire S-hooks matching EPSI HS 0.180 and 0.250 in boxes. 5% under." },
  { title: "HV Series V-Hooks", href: "/powder-coating-hooks/hv-series-v-hooks", category: "Products", description: "Round-wire V-hooks matching EPSI HV 0.180 and 0.250 in boxes. 5% under." },
  { title: "HCV Series CV-Hooks", href: "/powder-coating-hooks/hcv-series-cv-hooks", category: "Products", description: "Round-wire CV-hooks matching EPSI HCV 0.180 and 0.250 in boxes. 5% under." },
  { title: "HV90 Series 90° V-Hooks", href: "/powder-coating-hooks/hv90-series-90-degree-v-hooks", category: "Products", description: "Round-wire 90° V matching EPSI HV90 0.180 and 0.250 in boxes. 5% under." },
  ...
  { title: "Locking V-Hooks", href: "/powder-coating-hooks/locking-v-hooks", category: "Products", description: "Round-wire V plus a stay bend in 4–14 mm. Not EPSI HKVL 0.080 in bags." },
