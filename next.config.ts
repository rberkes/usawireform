...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/wire-hook", destination: "/s-hooks", permanent: true },
      { source: "/s-hook", destination: "/s-hooks", permanent: true },
      { source: "/v-hook", destination: "/v-hooks", permanent: true },
      { source: "/c-hook", destination: "/c-hooks", permanent: true },
      { source: "/cv-hook", destination: "/cv-hooks", permanent: true },
      {
